...
export default function CompraSucessoScreen() {
  ...
  const renderProximosPassos = () => (
    <Animated.View 
      style={[
        styles.proximosPassosContainer,
        {
          opacity: fadeAnim,
          transform: [{ translateY: slideAnim }]
        }
    ...
    >
      <Text style={styles.secaoTitulo}>Próximos Passos</Text>
      
      <View style={styles.passoItem}>
        <View style={styles.passoIcone}>
          <Ionicons name="mail" size={20} color="#48C9B0" />
        </View>
        <View style={styles.passoTexto}>
          <Text style={styles.passoTitulo}>Confirmação por Email</Text>
      ...
      <View style={styles.passoItem}>
        ...
        <View style={styles.passoTexto}>
          <Text style={styles.passoTitulo}>Preparação do Pedido</Text>
          <Text style={styles.passoDescricao}>
      ...
      <View style={styles.passoItem}>
        <View style={styles.passoIcone}>
          <Ionicons name="car" size={20} color="#48C9B0" />
        </View>
        <View style={styles.passoTexto}>
          <Text style={styles.passoTitulo}>Entrega</Text>
          <Text style={styles.passoDescricao}>
            Previsão de entrega: {dadosCompra.previsaoEntrega}
          </Text>
        </View>
      </View>
    </Animated.View>
